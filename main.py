...
async def set_caption(event):
    ...
    if not caption:
        await event.respond("⚠️ Harap tulis caption. Contoh:\n<code>/setcaption Halo semua!</code>", parse_mode='html')
        return
